    ...
    getData() {
        ...
        this.data.skills.forEach((s) => {
            ...
            for (let i = 0; i < s.level + 1; i++) {
                template[i] = template[i].replace('class="lvl"', 'class="lvl fill"');
            }
            template[s.level] = template[s.level].replace('class="lvl fill"', 'class="lvl current"');
        ...
        this.data.listSkillsFrontend = this.template.injectInterateData(this.listTemplateSkills, listSkillsFrontend);
        this.data.listSkillsDesign = this.template.injectInterateData(this.listTemplateSkills, listSkillsDesign);
        this.data.listSkillsBackend = this.template.injectInterateData(this.listTemplateSkills, listSkillsBackend);
        this.data.listSkillsAdmin = this.template.injectInterateData(this.listTemplateSkills, listSkillsAdmin);
        this.data.listEducation = this.template.injectInterateData(this.listTemplateEducation, this.data.education);
        this.data.listSoftSkills = this.template.injectInterateData(this.listTemplateLanguage, this.data.softSkills);
        this.data.listHardSkills = this.template.injectInterateData(this.listTemplateLanguage, this.data.hardSkills);
