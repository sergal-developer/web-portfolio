class r{constructor(){}injectData(i,n){let t=i;for(const a in n){const e=a;t=t.replaceAll(`{${e}}`,n[a])}return t}injectInterateData(i,n){let t="";return n.forEach(a=>{let e=i;for(const s in a){const o=`{${s}}`;e=e.replace(o,a[s])}t+=e}),t}}class d{constructor(){this.template=new r,this.data={title:"About",name:"Sergio Gallegos",email:"sergio.gallegos@live.com.mx",phone:"52+ 5516322613",birthday:"13 June 1988",nationality:"Mexican",subtitle:"Professional Profile",profileDescription:`<p>
    ...
    `}getData(){return this.template.injectData(this.html,this.data)}}class m{constructor(){this.template=new r,this.data={title:"Education",subtitle:"Just My Education",description:`<p>Sergio started working as a designer and programmer in 2008. During his first years he worked in projects
    ...
    <div class="full-divider"></div>`}getData(){return this.data.listEducation=this.template.injectInterateData(this.listTemplate,this.data.list),this.template.injectData(this.html,this.data)}}class c{constructor(){this.template=new r,this.data={title:"Experience",subtitle:"14 Years Experience!",description:`<p>
  ...
  <li class="timeline-event">
  ...
  </li>`,this.listTemplateTech="<div>{name}</div>"}getData(){return this.data.list.forEach(i=>{i.listTech=this.template.injectInterateData(this.listTemplateTech,i.tech)}),this.data.listExperience=this.template.injectInterateData(this.listTemplate,this.data.list),this.template.injectData(this.html,this.data)}}class p{constructor(){this.template=new r,this.data={title:"Hello, I'm ",name:"Sergio Gallegos",position:"Frontend Developer / Backend Developer"},this.html=`<div class="hero">
    <div class="text">
      <div class="static">
        <h2>
          <span>{title}</span><br>
    ...
    `}getData(){return this.template.injectData(this.html,this.data)}}class g{constructor(){this.template=new r,this.data={title:"Portfolio",subtitle:"Just My Work",description:`<p>Sergio started working as a designer and programmer in 2008. During his first years he worked in projects
      with technologies such as: JS, and ASP. In addition, he honed skills in graphic design, web development,
      and desktop application development with Microsoft Tecnologies. Sergio acknowledges the benefits of agile
      methodologies to ensure predictive delivery in software projects. He has experience working with Scrum and
      Kanban methods. Additionally, Sergio has a solid background in design patterns, OOP, and software
  ...
  <div class="full-divider"></div>`}getData(){return this.data.listPortfolio=this.template.injectInterateData(this.listTemplate,this.data.list),this.data.listPortfolio="<h1>Under Construction ...</h1>",this.template.injectData(this.html,this.data)}}class h{constructor(){this.template=new r,this.data={title:"Skills & Education",subtitle1:"Just My Skills",description1:"<p>Since 2008 I have developed knowledge in design, and programming oriented to backend and frontend, besides that I have worked under Scrum and Kanban methodologies, managed code using git scm in github and gitlab below I show you what technologies I have worked throughout these wonderful years.</p>",subtitle2:"Just My Education",description2:`<p>I studied at the Universidad Autonoma de México, 
